 ...
 *
 * Definition file for ICM45686 hardware driver interface
 *
 *****************************************************************************
 *
 ...
 *
 *****************************************************************************/
#ifndef _ICM45686_DEFINE_H_
#define _ICM45686_DEFINE_H_
...
#define accel_odr       (6 << 0)           // Output Data Rate 5 = 1600 Hz
...
#define gyro_odr                                                                                                                           \
  (6 << 0) // Output Data Rate, 3 = 6.4k, 4 = 3.2k, 5 = 1.6k, 6 = 800, 7 = 400, 8 = 200, 9 = 100, A = 50, B = 25, C = 12.5, D = 6.25, E
           // = 3.12, F = 1.56
...
/*
 * Indirect Register Addresses and Offsets
 */
#define IREG_ADDR_15_8 0x7c                    // Internal register address bits 15 to 8
#define IREG_ADDR_7_0  0x7d                    // Internal register address bits 7 to 0
#define IREG_DATA      0x7E                    // Value written or read from the indirect location
#define imem_sram      0x0000                  // Offset for SRAM
#define ipreg_bar      0xA000                  // Offset for pre-bar
#define ipreg_sys1     0xA400                  // Offset for system 1
#define ipreg_sys2     0xA500                  // Offset for system 2
#define ipreg_top1     0xA200                  // Offset for top 1

#define IPREG_SYS1_REG_166 (ipreg_sys1 | 0xA6) // Gyro source control
#define gyro_src_ctrl      (1 << 5)            // Interpolator OFF and FIR filter on

#define IPREG_SYS1_REG_172 (ipreg_sys1 | 0xAC) // Gyro Low pass filter
#define gyro_ui_lpfbw_sel  (1 << 0)            // Gyro low pass filter bandwidth selection ODR/16

#define IPREG_SYS2_REG_123 (ipreg_sys2 | 0x7B) // Accel source control
#define accel_src_ctrl     (1 << 0)            // Interpolator OFF and FIR filter on

#define IPREG_SYS2_REG_131 (ipreg_sys2 | 0x83) // Accel bandwidth control
#define accel_ui_lpfbw_sel  (1 << 0)            // Accel low pass filter bandwidth selection ODR/16
...
typedef struct
{
  uint16_t i_address; // Indirect register being accessed
  uint8_t  value;     // Value to be written to the register
} ICM45686_indirect_config_t;
...
static const ICM45686_indirect_config_t ICM45686_indirect_config[] = {
    {IPREG_SYS1_REG_166, gyro_src_ctrl     },
    {IPREG_SYS1_REG_172, gyro_ui_lpfbw_sel },
    {IPREG_SYS2_REG_123, accel_src_ctrl    },
    {IPREG_SYS2_REG_131, accel_ui_lpfbw_sel},
    {0,                  0                 }
};
