...
static const self_test_t test_list[] = {
    {"Help",                         &show_test_help           },
    {"Factory test",                 (void*)&factory_test             },
    {"- Digital",                    0                         },
    {"Digital inputs",               &digital_input_test       },
    {"Digital outputs",              &digital_output_test      },

    {"- ICM-45686",                  0                         },
    {"Accelerometer zeroing",        (void*)&ICM45686_find_zero       },
...
const dlt_name_t dlt_names[] = {
    ...
    {DLT_TIMING,        "DLT_TIMING",        'T'}, // Show timing history
...
const state_name_t state_names[] = {
    ...
    {IN_FIFO_FRESH,    "IN_FIFO_FRESH"   }, // New FIFO data is present
