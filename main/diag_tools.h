...
#define DLT_TIMING        (DLT_DEBUG << 1)         // Show timing history
#define DLT_HTTP          (DLT_TIMING << 1)        // Log HTTP requests
...
#if ( ((DLT_FATAL | DLT_CRITICAL | DLT_INFO | DLT_APPLICATION | DLT_COMMUNICATION | DLT_DIAG | DLT_DEBUG | DLT_TIMING | DLT_SCORE |        \
        DLT_HTTP | DLT_PAUSE) &                                                                                                            \
